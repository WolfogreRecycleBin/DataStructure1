...
public:
//  单链表的函数成员 
	friend LinkList<ElemType> Add(const LinkList<ElemType> &a,const LinkList<ElemType> &a);
	LinkList();							// 无参数的构造函数
...
LinkList<int> Add(const LinkList<int> &a,const LinkList<int> &b)
{
	LinkList<int> t;
	Node<int> *p;
	p=a.head->next;
